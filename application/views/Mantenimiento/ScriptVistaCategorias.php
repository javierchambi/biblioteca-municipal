...
<script>
    $(document).on("click","#add",function(e){
        ...
        {
          $.ajax({
            url: "<?php echo base_url();?>Mantenimiento/Categorias/insertar",
            type: "post",
            dataType: "json",
            data:
            {
...
<script>
    $(document).on("click","#edit",function(e){
          ...
          //alert(edit_id);
          $.ajax({
            url: '<?php echo base_url(); ?>Mantenimiento/Categorias/modal_edicion',
            type: "post",
            dataType: "json",
            data: {
              edit_id : edit_id
            ...
            success: function(data)
            {
                ...
                $("#descripcion_ed").val(data.post.Descripcion_c);
            }
          });
        });
  </script>
  <script>
    $(document).on("click","#updt",function(e){
          ...
          {
            $.ajax({
              url: '<?php echo base_url(); ?>Mantenimiento/Categorias/actualizacion',
              type: "post",
              dataType: "json",
              data:
              {
   ...
   <script>
    $(document).on("click","#del",function(e){
          ...
          callback: function (result) {
            ...
            {
                $.ajax({
                url: "<?php echo base_url(); ?>Mantenimiento/Categorias/eliminar",
                type: "post",
                dataType: "json",
                data: {
                  nro: nro
