<div class="br-mainpanel" style="position: relative;">
    <div class="pd-30">
        <h4 class="tx-gray-800 mg-b-5">Listado de categorias de libros disponibles</h4>
           <br>
           <a href="" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" data-toggle="modal" data-target="#modalInsert">Registrar nueva categoria</a>
           <br><br>
                          ...
                          <div class="col-lg-6 bg-white">
                            <div class="pd-30">
                              ...
                              <div class="pd-x-30 pd-y-10">
                                <h3 class="tx-inverse  mg-b-5">Nueva categoria</h3>
                                <br>
