...
class Libros extends CI_Controller 
{
	...
	{
		parent::__construct();
		$this->load->model("Libros/ModelLibros");
	}
	public function index()
	{
        $data = array(
            'libro' => $this->ModelLibros->mostrar_datos(),
            'tipo' => $this->ModelLibros->mostrar_tipos(),
            'categoria' => $this->ModelLibros->mostrar_categorias(),
            'solo_libros' => $this->ModelLibros->mostrar_solo_libros()
		);
        if($this->session->userdata('Login'))
		{
            if($this->session->userdata('Tipo')=="Admin")
            {
                ...
                $this->load->view('Libros/VistaLIbros',$data);
                $this->load->view('Layout/Footer');
                $this->load->view('Libros/ScriptVistaLibros');
            }
            else
            {
                $this->load->view('Layout/Header');
